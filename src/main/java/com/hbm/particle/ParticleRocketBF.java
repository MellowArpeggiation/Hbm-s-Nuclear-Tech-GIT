...
public class ParticleRocketBF extends EntityFX {
	
	private int age;
	private int maxAge;

	public ParticleRocketBF(TextureManager p_i1213_1_, World p_i1218_1_, double p_i1218_2_, double p_i1218_4_, double p_i1218_6_) {
	...
	public ParticleRocketBF setScale(float scale) {
		this.particleScale = scale;
		return this;
	}
	
	public ParticleRocketBF setMaxAge(int maxAge) {
		this.maxAge = maxAge;
		return this;
	}

...
public class ParticleRocketMUD extends EntityFX {
	
	private int age;
	private int maxAge;

	public ParticleRocketMUD(TextureManager p_i1213_1_, World p_i1218_1_, double p_i1218_2_, double p_i1218_4_, double p_i1218_6_) {
	...
	public ParticleRocketMUD setScale(float scale) {
		this.particleScale = scale;
		return this;
	}
	
	public ParticleRocketMUD setMaxAge(int maxAge) {
		this.maxAge = maxAge;
		return this;
	}
	...
	public void renderParticle(Tessellator p_70539_1_, float interp, float sX, float sY, float sZ, float dX, float dZ) {
		...
		for(int i = 0; i < 10; i++) {
			...
			this.particleGreen = 0 * light + add;
			...
			p_70539_1_.setNormal(0.9F, 0.7F, 0.0F);
			p_70539_1_.setBrightness(20);

...
public class ModBlocks {
	...
	private static void initializeBlock() {
		...
		crop_strawberry = new BlockCrop(ModBlocks.rubber_farmland, new SimpleEntry<>(Fluids.TEKTOAIR, 0.1f), new SimpleEntry<>(Fluids.HELIUM3, 0.1f)).setBlockName("crop_strawberry").setStepSound(Block.soundTypeGrass).setHardness(0.0F).setBlockTextureName(RefStrings.MODID + ":strawberry");
		crop_coffee = new BlockCrop(Blocks.farmland, new SimpleEntry<>(Fluids.AIR, 0.01f),new SimpleEntry<>(Fluids.OXYGEN, 0.01f)).setBlockName("crop_coffee").setStepSound(Block.soundTypeGrass).setHardness(0.0F).setBlockTextureName(RefStrings.MODID + ":coffee");
		crop_tea = new BlockCrop(Blocks.farmland, new SimpleEntry<>(Fluids.AIR, 0.01f),new SimpleEntry<>(Fluids.OXYGEN, 0.01f)).setBlockName("crop_tea").setStepSound(Block.soundTypeGrass).setHardness(0.0F).setBlockTextureName(RefStrings.MODID + ":tea");
		...
		machine_magma = new MachineMagma().setBlockName("machine_magnma").setHardness(5.0F).setResistance(100.0F).setCreativeTab(MainRegistry.machineTab).setBlockTextureName(RefStrings.MODID + ":block_steel");

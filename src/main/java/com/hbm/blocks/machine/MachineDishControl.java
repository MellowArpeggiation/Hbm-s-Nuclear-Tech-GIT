...
public class MachineDishControl extends BlockContainer {
	...
	public TileEntity createNewTileEntity(World p_149915_1_, int p_149915_2_) {
		return new TileEntityDishControl();
	}
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ) {
		...
		{
			TileEntityDishControl entityDishControl = (TileEntityDishControl) world.getTileEntity(x, y, z);

			System.out.println("Control tile entity");

			if (entityDishControl.dish == null) return false;

			System.out.println("Control has dish");

			System.out.println(entityDishControl.dish.xCoord + " " + entityDishControl.dish.yCoord + " " + entityDishControl.dish.zCoord);

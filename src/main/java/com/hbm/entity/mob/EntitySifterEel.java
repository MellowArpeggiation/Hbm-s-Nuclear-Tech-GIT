...
public class EntitySifterEel extends EntityWaterMob {
	...
	private void moveTowardsTarget() {
		...
		double speed = 0.01;
		this.motionX += dirX * speed + (rand.nextDouble() - 0.5) / 24;
		this.motionY += dirY * speed + (rand.nextDouble() - 0.5) / 24;
		this.motionZ += dirZ * speed + (rand.nextDouble() - 0.5) / 24;
